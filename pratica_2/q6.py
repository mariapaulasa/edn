...
def main():
    try:
        numero_funcionario = int(input("Digite o número do funcionário (inteiro): "))
        horas_trabalhadas = int(input("Digite a quantidade de horas trabalhadas (inteiro): "))
        valor_por_hora = float(input("Digite o valor recebido por hora (com duas casas decimais): "))
    except ValueError:
